...
NUM_REG_BITS = 3
NUM_PORT_BITS = NUM_REG_BITS
NUM_JUMP_BITS = 16 - (NUM_OPC_BITS)
NUM_LEA_BITS = 16 - (NUM_OPC_BITS + NUM_REG_BITS)
NUM_BASER_OFFSET_BITS = 16 - (NUM_OPC_BITS + NUM_REG_BITS + NUM_REG_BITS)
NUM_IMM_BITS = 16 - (NUM_OPC_BITS + NUM_REG_BITS)
